import numpy as np
from constants import MAX_ROLL_RATE, MAX_PITCH_RATE, MAX_YAW_RATE, MAX_ROLL_ANGLE, MAX_YAW_ANGLE, MAX_PITCH_ANGLE, MAX_HORIZONTAL_VELOCITY, MAX_ASCENT_RATE, MAX_DESCENT_RATE_TILTED, MAX_DESCENT_RATE
