...
DEFAULTS_FLIGHT = {
    ...
    "RO_0": 1.225,
    "velocity": 6.0,
    "altitude_start": 3.0,          # ujednolicone z promptem
    "altitude_cruise_min": 4.0,
...
def limits(use_default: bool = False):
    ...
    return (thrust_max, thrust_min,
            max_pitch_rate_rad, max_roll_rate_rad, max_yaw_rate_rad,
...
def control_parameters(use_default: bool = False):
    ...
    r = float(r_input) if r_input else C["r"]
    if use_default:
        print(f"R: {r}")
    ...
    return (Q_velocity_x, Q_velocity_y, Q_velocity_z,
            ...
            Q_phi, Q_theta, Q_psi, Q_thrust, r)
...
def input_parameters():
    ...
    (Q_velocity_x, Q_velocity_y, Q_velocity_z,
     Q_angular_rate_p, Q_angular_rate_q, Q_angular_rate_r,
     Q_position_X, Q_position_Y, Q_position_Z,
     Q_phi, Q_theta, Q_psi, Q_thrust, r) = control_parameters(use_default)
